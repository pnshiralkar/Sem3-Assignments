...
Write a C++ program that creates an output file, writes information to it, closes the file and opens it again as an input file and read the information from the file.
...
void dbase::search(int key,int *c)
{
	if(key == rollno)
		*c = 1;
	else
